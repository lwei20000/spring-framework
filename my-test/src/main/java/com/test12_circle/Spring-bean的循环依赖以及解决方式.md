...
![这里写图片描述](https://cdn.jsdelivr.net/gh/lwei20000/pic/SouthEast-20210225114805474.jpeg)
...
![bean初始化](https://cdn.jsdelivr.net/gh/lwei20000/pic/SouthEast-20210225114814458.jpeg) 
...
DefaultSingletonBeanRegistry.java----------getSingleton()
```
...
知道了这个原理时候，肯定就知道为啥Spring不能解决“A的构造方法中依赖了B的实例对象，同时B的构造方法中依赖了A的实例对象”这类问题了！因为加入singletonFactories三级缓存的前提是执行了构造器，所以**构造器的循环依赖没法解决**。